...
public:
    ...
    Wspolne_obiekty(grafiki& grafika) : opcje(grafika.menu_png, grafika.czcionka), obrotomierz(grafika.obrotomierz_png), wskazowka_obrotomierz(grafika.wskazowka_png), obroty(grafika.czcionka),
...
public:
    ...
    Obiekty_wspolne(grafiki& grafika) :
        bateria(grafika.czcionka), bateria_zdj(grafika.bateria_png), bateria_dead_zdj(grafika.bateria_low_png),
        woda(grafika.czcionka), woda_zdj(grafika.woda_png), woda_overheat_zdj(grafika.woda_overheat_png),
        cisnienie_oleju(grafika.czcionka), cisnienieoleju_zdj(grafika.cisnienieolej_png),
        wysokie_cisnienieoleju_zdj(grafika.wcisnienieolej_png), paliwo_zdj(grafika.paliwo_png), rezerwa_zdj(grafika.rezerwa_png) {
    }
};

//DLA TRYBU CYFROWEGO
class Obiekty_cyfrowy {
public:
    Ladowanie_grafik obrotomierz_cyfrowy;
    Prosty_prostokat obroty_cyfrowy;
    Wyswietlanie l_obroty_cyfrowy;
...
Obiekty_analogowy(grafiki& grafika) :
    ...
    temperatura_oleju(grafika.olej_png), wskazowka_tempoleju(grafika.wskazowka_png), bieg(grafika.czcionka) {
}
};