...
int main() {
    ...
    opcje.aktualizuj_wymiary_guzikow({ 640,60 }, { 640, 110 }, { 130,30 }, sf::Color::Transparent, { 255,0,0 }, 2);
    opcje.set_text("Zegary analogowe", "Zegary cyfrowe", "Menu", { 645,70 }, { 645, 120 }, { 635,20 }, 10);
